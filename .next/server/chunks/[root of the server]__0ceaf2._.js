...
"[project]/models/Order.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/config/inngest.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_esm__({
    ...
    "inngest": (()=>inngest),
    "syncUserCreation": (()=>syncUserCreation),
    "syncUserDeletion": (()=>syncUserDeletion),
    "syncUserUpdation": (()=>syncUserUpdation)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/config/db.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Order.js [app-route] (ecmascript)");
;
;
;
;
...
const syncUserCreation = inngest.createFunction({
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create(userData);
});
const syncUserUpdation = inngest.createFunction({
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, userData);
});
const syncUserDeletion = inngest.createFunction({
    ...
    const { id } = event.data;
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
});
const createUserOrder = inngest.createFunction({
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Order$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].insertMany(orders);
    return {
        success: true,
...
"[project]/app/api/order/create/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$inngest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/config/inngest.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/Product.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/models/User.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        const { address, items, payment_id, razorpay_order_id, signature, payment_mode } = await request.json();
        ...
        const amount = await items.reduce(async (accPromise, item)=>{
            ...
            const product = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Product$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(item.product);
        ...
        if (payment_mode !== "COD") {
            const expectedSignature = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac("sha256", process.env.RAZORPAY_SECRET).update(`${razorpay_order_id}|${payment_id}`).digest("hex");
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$config$2f$inngest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inngest"].send({
            name: "order/created",
            data: {
                userId,
                address,
        ...
        // 🧹 Clear cart
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(userId);
        if (user) {
            user.cartItems = {};
            await user.save();
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__0ceaf2._.js.map