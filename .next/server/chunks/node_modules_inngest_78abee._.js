...
exports.version = "3.31.3"; //# sourceMappingURL=version.js.map
}}),
...
"[project]/node_modules/inngest/proto/google/protobuf/timestamp.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
/* eslint-disable */ const wire_1 = __turbopack_require__("[project]/node_modules/@bufbuild/protobuf/dist/cjs/wire/index.js [app-route] (ecmascript)");
...
"[project]/node_modules/inngest/proto/src/components/connect/protobuf/connect.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
exports.FlushResponse = exports.StartRequest = exports.StartResponse = exports.ConnGroup = exports.SystemAttributes = exports.ConnMetadata = exports.WorkerReplyAckData = exports.SDKResponse = exports.WorkerRequestAckData = exports.GatewayExecutorRequestData = exports.GatewaySyncRequestData = exports.WorkerConnectRequestData = exports.AuthData = exports.ConfigDetails = exports.SessionDetails = exports.SessionIdentifier = exports.ConnectMessage = exports.WorkerDisconnectReason = exports.ConnectionStatus = exports.SDKResponseStatus = exports.GatewayMessageType = exports.protobufPackage = void 0;
...
/* eslint-disable */ const wire_1 = __turbopack_require__("[project]/node_modules/@bufbuild/protobuf/dist/cjs/wire/index.js [app-route] (ecmascript)");
const timestamp_1 = __turbopack_require__("[project]/node_modules/inngest/proto/google/protobuf/timestamp.js [app-route] (ecmascript)");
...
function createBaseSessionIdentifier() {
    return {
        instanceId: "",
        connectionId: "",
        buildId: undefined
...
exports.SessionIdentifier = {
    ...
    create (base) {
        return exports.SessionIdentifier.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial (object) {
        var _a, _b, _c;
        const message = createBaseSessionIdentifier();
        ...
        message.buildId = (_c = object.buildId) !== null && _c !== void 0 ? _c : undefined;
        return message;
    }
};
function createBaseSessionDetails() {
    return {
        sessionId: undefined,
        functionHash: new Uint8Array(0)
    };
}
exports.SessionDetails = {
    encode (message, writer = new wire_1.BinaryWriter()) {
        if (message.sessionId !== undefined) {
            exports.SessionIdentifier.encode(message.sessionId, writer.uint32(10).fork()).join();
        }
                ...
                case 1:
                    {
                        ...
                        message.sessionId = exports.SessionIdentifier.decode(reader, reader.uint32());
                        continue;
                    }
                case 3:
                    {
    ...
    fromJSON (object) {
        return {
            sessionId: isSet(object.sessionId) ? exports.SessionIdentifier.fromJSON(object.sessionId) : undefined,
    ...
    toJSON (message) {
        const obj = {};
        if (message.sessionId !== undefined) {
            obj.sessionId = exports.SessionIdentifier.toJSON(message.sessionId);
        }
        if (message.functionHash.length !== 0) {
    ...
    create (base) {
        return exports.SessionDetails.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial (object) {
        var _a;
        const message = createBaseSessionDetails();
        message.sessionId = object.sessionId !== undefined && object.sessionId !== null ? exports.SessionIdentifier.fromPartial(object.sessionId) : undefined;
        message.functionHash = (_a = object.functionHash) !== null && _a !== void 0 ? _a : new Uint8Array(0);
        return message;
    }
};
function createBaseConfigDetails() {
    return {
...
exports.ConfigDetails = {
    ...
    create (base) {
        return exports.ConfigDetails.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial (object) {
        var _a, _b;
        const message = createBaseConfigDetails();
        message.capabilities = (_a = object.capabilities) !== null && _a !== void 0 ? _a : new Uint8Array(0);
        message.functions = (_b = object.functions) !== null && _b !== void 0 ? _b : new Uint8Array(0);
        return message;
    }
};
...
exports.WorkerConnectRequestData = {
    encode (message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.authData !== undefined) {
            exports.AuthData.encode(message.authData, writer.uint32(18).fork()).join();
        }
        if (message.appName !== "") {
            writer.uint32(26).string(message.appName);
        }
        if (message.config !== undefined) {
            exports.ConfigDetails.encode(message.config, writer.uint32(34).fork()).join();
        }
        ...
        if (message.systemAttributes !== undefined) {
            exports.SystemAttributes.encode(message.systemAttributes, writer.uint32(50).fork()).join();
        }
                ...
                case 4:
                    {
                        ...
                        message.config = exports.ConfigDetails.decode(reader, reader.uint32());
                        continue;
                    }
                case 5:
                    {
    ...
    fromJSON (object) {
        return {
            ...
            config: isSet(object.config) ? exports.ConfigDetails.fromJSON(object.config) : undefined,
    ...
    toJSON (message) {
        ...
        if (message.config !== undefined) {
            obj.config = exports.ConfigDetails.toJSON(message.config);
        }
        if (message.workerManualReadinessAck !== false) {
    ...
    fromPartial (object) {
        ...
        const message = createBaseWorkerConnectRequestData();
        message.sessionId = object.sessionId !== undefined && object.sessionId !== null ? exports.SessionIdentifier.fromPartial(object.sessionId) : undefined;
        message.authData = object.authData !== undefined && object.authData !== null ? exports.AuthData.fromPartial(object.authData) : undefined;
        message.appName = (_a = object.appName) !== null && _a !== void 0 ? _a : "";
        message.config = object.config !== undefined && object.config !== null ? exports.ConfigDetails.fromPartial(object.config) : undefined;
        message.workerManualReadinessAck = (_b = object.workerManualReadinessAck) !== null && _b !== void 0 ? _b : false;
        message.systemAttributes = object.systemAttributes !== undefined && object.systemAttributes !== null ? exports.SystemAttributes.fromPartial(object.systemAttributes) : undefined;
        message.environment = (_c = object.environment) !== null && _c !== void 0 ? _c : undefined;
        message.framework = (_d = object.framework) !== null && _d !== void 0 ? _d : "";
        message.platform = (_e = object.platform) !== null && _e !== void 0 ? _e : undefined;
        message.sdkVersion = (_f = object.sdkVersion) !== null && _f !== void 0 ? _f : "";
        message.sdkLanguage = (_g = object.sdkLanguage) !== null && _g !== void 0 ? _g : "";
        message.startedAt = (_h = object.startedAt) !== null && _h !== void 0 ? _h : undefined;
        return message;
    }
};
function createBaseGatewaySyncRequestData() {
    return {
        deployId: undefined
    };
}
exports.GatewaySyncRequestData = {
    encode (message, writer = new wire_1.BinaryWriter()) {
    ...
    fromJSON (object) {
        return {
            deployId: isSet(object.deployId) ? globalThis.String(object.deployId) : undefined
        };
    },
    toJSON (message) {
        const obj = {};
    ...
    create (base) {
        return exports.GatewaySyncRequestData.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial (object) {
        var _a;
        const message = createBaseGatewaySyncRequestData();
        message.deployId = (_a = object.deployId) !== null && _a !== void 0 ? _a : undefined;
        return message;
    }
};
...
exports.GatewayExecutorRequestData = {
    ...
    fromPartial (object) {
        ...
        message.functionSlug = (_d = object.functionSlug) !== null && _d !== void 0 ? _d : "";
        message.stepId = (_e = object.stepId) !== null && _e !== void 0 ? _e : undefined;
        message.requestPayload = (_f = object.requestPayload) !== null && _f !== void 0 ? _f : new Uint8Array(0);
        return message;
    }
};
...
exports.WorkerRequestAckData = {
    ...
    fromPartial (object) {
        ...
        message.functionSlug = (_c = object.functionSlug) !== null && _c !== void 0 ? _c : "";
        message.stepId = (_d = object.stepId) !== null && _d !== void 0 ? _d : undefined;
        return message;
    }
};
...
exports.SDKResponse = {
    ...
    fromPartial (object) {
        ...
        message.body = (_e = object.body) !== null && _e !== void 0 ? _e : new Uint8Array(0);
        message.noRetry = (_f = object.noRetry) !== null && _f !== void 0 ? _f : false;
        message.retryAfter = (_g = object.retryAfter) !== null && _g !== void 0 ? _g : undefined;
        message.sdkVersion = (_h = object.sdkVersion) !== null && _h !== void 0 ? _h : "";
        message.requestVersion = (_j = object.requestVersion) !== null && _j !== void 0 ? _j : 0;
        return message;
    }
};
...
exports.ConnMetadata = {
    encode (message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.lastHeartbeatAt !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.lastHeartbeatAt), writer.uint32(50).fork()).join();
        }
        if (message.language !== "") {
        ...
        if (message.attributes !== undefined) {
            exports.SystemAttributes.encode(message.attributes, writer.uint32(74).fork()).join();
        }
        return writer;
    },
    decode (input, length) {
    ...
    fromPartial (object) {
        ...
        message.groupId = (_d = object.groupId) !== null && _d !== void 0 ? _d : "";
        message.status = (_e = object.status) !== null && _e !== void 0 ? _e : 0;
        message.lastHeartbeatAt = (_f = object.lastHeartbeatAt) !== null && _f !== void 0 ? _f : undefined;
        message.language = (_g = object.language) !== null && _g !== void 0 ? _g : "";
        message.version = (_h = object.version) !== null && _h !== void 0 ? _h : "";
        message.attributes = object.attributes !== undefined && object.attributes !== null ? exports.SystemAttributes.fromPartial(object.attributes) : undefined;
        return message;
    }
};
...
exports.ConnGroup = {
    encode (message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.conns){
            exports.ConnMetadata.encode(v, writer.uint32(34).fork()).join();
        }
    ...
    fromPartial (object) {
        ...
        message.conns = ((_d = object.conns) === null || _d === void 0 ? void 0 : _d.map((e)=>exports.ConnMetadata.fromPartial(e))) || [];
        message.syncId = (_e = object.syncId) !== null && _e !== void 0 ? _e : undefined;
        message.buildId = (_f = object.buildId) !== null && _f !== void 0 ? _f : undefined;
        return message;
    }
};
...
exports.StartResponse = {
    ...
    fromPartial (object) {
        var _a, _b, _c, _d;
        const message = createBaseStartResponse();
        message.gatewayEndpoint = (_a = object.gatewayEndpoint) !== null && _a !== void 0 ? _a : "";
        message.gatewayGroup = (_b = object.gatewayGroup) !== null && _b !== void 0 ? _b : "";
        message.sessionToken = (_c = object.sessionToken) !== null && _c !== void 0 ? _c : "";
        message.syncToken = (_d = object.syncToken) !== null && _d !== void 0 ? _d : "";
        return message;
    }
};
...
exports.StartRequest = {
    ...
    fromJSON (object) {
        return {
            excludeGateways: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.excludeGateways) ? object.excludeGateways.map((e)=>globalThis.String(e)) : []
        };
    },
    toJSON (message) {
        var _a;
...
"[project]/node_modules/inngest/components/connect/util.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/inngest/components/connect/buffer.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const debug_1 = __importDefault(__turbopack_require__("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)"));
const consts_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/consts.js [app-route] (ecmascript)");
const connect_js_1 = __turbopack_require__("[project]/node_modules/inngest/proto/src/components/connect/protobuf/connect.js [app-route] (ecmascript)");
const util_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/util.js [app-route] (ecmascript)");
class MessageBuffer {
    constructor(inngest){
        this.buffered = {};
        this.pending = {};
    ...
    async sendFlushRequest(hashedSigningKey, msg) {
        ...
        const resp = await fetch(// refactor this to a more universal spot
...
exports.MessageBuffer = MessageBuffer; //# sourceMappingURL=buffer.js.map
}}),
"[project]/node_modules/inngest/components/connect/messages.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/inngest/components/connect/os.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
async function retrieveCpuCores() {
    ...
    try {
        const os = await Promise.resolve().then(()=>__importStar(__turbopack_require__("[externals]/node:os [external] (node:os, cjs)")));
...
"[project]/node_modules/inngest/components/connect/types.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
exports.DEFAULT_SHUTDOWN_SIGNALS = [
    "SIGINT",
    "SIGTERM"
];
var ConnectionState;
...
})(ConnectionState || (exports.ConnectionState = ConnectionState = {})); //# sourceMappingURL=types.js.map
}}),
"[project]/node_modules/inngest/components/connect/index.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const waitgroup_1 = __turbopack_require__("[project]/node_modules/@jpwilliams/waitgroup/lib/index.js [app-route] (ecmascript)");
const debug_1 = __importDefault(__turbopack_require__("[project]/node_modules/debug/src/index.js [app-route] (ecmascript)"));
const ulid_1 = __turbopack_require__("[project]/node_modules/ulid/dist/index.esm.js [app-route] (ecmascript)");
const consts_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/consts.js [app-route] (ecmascript)");
const env_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/env.js [app-route] (ecmascript)");
const functions_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/functions.js [app-route] (ecmascript)");
const strings_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/strings.js [app-route] (ecmascript)");
...
const buffer_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/buffer.js [app-route] (ecmascript)");
const messages_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/messages.js [app-route] (ecmascript)");
const os_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/os.js [app-route] (ecmascript)");
const types_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/types.js [app-route] (ecmascript)");
const util_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/util.js [app-route] (ecmascript)");
...
class WebSocketWorkerConnection {
    constructor(inngest, options){
        ...
        this.messageBuffer = new buffer_js_1.MessageBuffer(inngest);
    ...
    get functions() {
        var _a, _b;
        return (_b = (_a = this.options.functions) !== null && _a !== void 0 ? _a : this.inngest["localFns"]) !== null && _b !== void 0 ? _b : [];
    }
    applyDefaults(opts) {
        ...
        options.signingKeyFallback = options.signingKeyFallback || env[consts_js_1.envKeys.InngestSigningKeyFallback];
        return options;
    }
    // eslint-disable-next-line @typescript-eslint/require-await
    async close() {
     ...
     */ async connect(attempt = 0, path = []) {
        ...
        this._hashedSigningKey = this.options.signingKey ? (0, strings_js_1.hashSigningKey)(this.options.signingKey) : undefined;
        ...
        const functions = this.functions.flatMap((f)=>f["getConfig"]({
        ...
        if (this.options.handleShutdownSignals && this.options.handleShutdownSignals.length > 0) {
            this.setupShutdownSignal(this.options.handleShutdownSignals);
        }
        let useSigningKey = this._hashedSigningKey;
        while(![
            types_js_1.ConnectionState.CLOSING,
            types_js_1.ConnectionState.CLOSED
        ].includes(this.state)){
            ...
            try {
                await this.prepareConnection(requestHandler, useSigningKey, data, attempt, [
                    ...path
                ]);
                return;
            } catch (err) {
                ...
                const cancelled = await (0, util_js_1.waitWithCancel)(delay, ()=>this.state === types_js_1.ConnectionState.CLOSING || this.state === types_js_1.ConnectionState.CLOSED);
                if (cancelled) {
    ...
    async sendStartRequest(hashedSigningKey, attempt) {
        ...
        if (!resp.ok) {
            if (resp.status === 401) {
                throw new util_js_1.AuthError(`Failed initial API handshake request to ${targetUrl.toString()}, ${await resp.text()}`, attempt);
            }
            if (resp.status === 429) {
    ...
    async prepareConnection(requestHandler, hashedSigningKey, data, attempt, path = []) {
        ...
        ws.onmessage = async (event)=>{
            ...
            if (connectMessage.kind === connect_js_1.GatewayMessageType.GATEWAY_CLOSING) {
                isDraining = true;
                this.debug("Received draining message", {
                    connectionId
                });
                try {
                    this.debug("Setting up new connection while keeping previous connection open", {
                        connectionId
                    });
...
const connect = async (inngest, options)=>{
    const conn = new WebSocketWorkerConnection(inngest, options);
    await conn.connect();
    return conn;
};
exports.connect = connect; //# sourceMappingURL=index.js.map
}}),
...
const ai_1 = __turbopack_require__("[project]/node_modules/@inngest/ai/dist/index.js [app-route] (ecmascript)");
const zod_1 = __turbopack_require__("[project]/node_modules/zod/lib/index.js [app-route] (ecmascript)");
const consts_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/consts.js [app-route] (ecmascript)");
const strings_js_1 = __turbopack_require__("[project]/node_modules/inngest/helpers/strings.js [app-route] (ecmascript)");
const types_js_1 = __turbopack_require__("[project]/node_modules/inngest/types.js [app-route] (ecmascript)");
...
const types_js_1 = __turbopack_require__("[project]/node_modules/inngest/types.js [app-route] (ecmascript)");
const index_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/connect/index.js [app-route] (ecmascript)");
const InngestFunction_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/InngestFunction.js [app-route] (ecmascript)");
const InngestMiddleware_js_1 = __turbopack_require__("[project]/node_modules/inngest/components/InngestMiddleware.js [app-route] (ecmascript)");
/**
 ...
 */ class Inngest {
     ...
     */ constructor(options){
        ...
        this.options = options;
        const { id, fetch, logger = new logger_js_1.DefaultLogger(), middleware, isDev, schemas, buildId } = this.options;
        if (!id) {
            // TODO PrettyError
     ...
     */ async connect(opts) {
        return (0, index_js_1.connect)(this, opts);
    }
}
...
__exportStar(__turbopack_require__("[project]/node_modules/@inngest/ai/dist/index.js [app-route] (ecmascript)"), exports);
...
//# sourceMappingURL=node_modules_inngest_78abee._.js.map