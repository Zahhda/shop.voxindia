...
const AppContextProvider = (props)=>{
    ...
    const fetchProductData = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/product/list');
            if (data.success) {
    ...
    const fetchUserData = async ()=>{
        try {
            ...
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/api/user/data', {
                headers: {
    ...
    const addToCart = async (itemId)=>{
        if (!user) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])('Please login', {
                icon: '⚠️'
            });
        }
        ...
        if (user) {
            try {
                const token = await getToken();
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/api/cart/update', {
                    cartData
                }, {
                    headers: {
                        Authorization: `Bearer ${token}`
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1bf57c._.js.map