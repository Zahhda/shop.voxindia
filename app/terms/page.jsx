...
export default function TermsAndConditionsPage() {
  return (
    <>
      ...
      <p>
        Welcome to <strong>VOX India</strong>. These Terms and Conditions govern your access to and use of our e-commerce platform located at <a href="https://www.shop.voxindia.co" className="text-red-700 underline">https://www.shop.voxindia.co</a>. By accessing our platform, you agree to be bound by these terms.
      </p>
